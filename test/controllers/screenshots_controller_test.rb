...
class ScreenshotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screenshot" do
    assert_difference('Screenshot.count') do
      post screenshots_url, params: { screenshot: { image_data: @screenshot.image_data, link_id: @screenshot.link_id, title: @screenshot.title } }
    end
  ...
  test "should update screenshot" do
    patch screenshot_url(@screenshot), params: { screenshot: { image_data: @screenshot.image_data, link_id: @screenshot.link_id, title: @screenshot.title } }
